...
<body>
  ...
  <section class="section main-banner" id="top" data-section="section1">
      <video autoplay muted loop id="bg-video">
          <source src="assets/images/vida.mp4" type="video/mp4" />
      </video>

      <div class="video-overlay header-text">
          <div class="caption">
              <h6>Home of african education</h6>
              <h2><em>Choose</em> quality</h2>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="section-heading">
            <h2>Why choose Uzami Academy?</h2>
          </div>
        </div>
        <div class="col-md-12">
          <div id='tabs'>
              ...
              <article id='tabs-1'>
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <p>ihwnuechw eehniwendw ewnbeicnweicnwe wenciwecnwiencwinecw ecniwecnwoiecnwioencwionecwe cwue ncnw eicnw</p>
                  </div>
                </div>
              </article>
              <article id='tabs-2'>
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <h4>Top Level</h4>
                    <p>nweindw ejdb wieb dniwe dwje diw ediwje djwie diweb dwejc wej chj shufd vhwr tvhw revho werhv rehi vehr vphier vwhie rv</p>
